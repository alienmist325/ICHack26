...
class ApiClient {
  ...
  async getProperties(params: {
    ...
    if (params.min_bedrooms !== undefined)
      queryParams.append("min_bedrooms", String(params.min_bedrooms));
    if (params.max_bedrooms !== undefined)
      queryParams.append("max_bedrooms", String(params.max_bedrooms));
    if (params.property_type)
      queryParams.append("property_type", params.property_type);
    if (params.furnishing_type)
      queryParams.append("furnishing_type", params.furnishing_type);
  ...
  async getLatLong(body: GeocodeRequest): Promise<GeocodeResponse> {
    const response = await fetch(`${this.baseUrl}/routing/geocode`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  async getRatings(propertyId: number): Promise<RatingResponse[]> {
    const response = await fetch(
      `${this.baseUrl}/properties/${propertyId}/ratings`,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
  ...
  async starProperty(propertyId: number): Promise<any> {
    const response = await fetch(
      `${this.baseUrl}/properties/${propertyId}/star`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
  ...
  async unstarProperty(propertyId: number): Promise<any> {
    const response = await fetch(
      `${this.baseUrl}/properties/${propertyId}/unstar`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
  ...
  async setPropertyStatus(propertyId: number, status: string): Promise<any> {
    const response = await fetch(
      `${this.baseUrl}/properties/${propertyId}/status`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
